...
def course_detail(request,course_id):
    context = {}
    context["course_info"]=Course.objects.get(id=course_id)
    context["user"]=request.user
    context["hero_title"]=Course.objects.get(id=course_id).name
    return render_to_response("bootstrap/course_detail.html", context)
